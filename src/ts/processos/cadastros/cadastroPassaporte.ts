...
export default class CadastroPassaporte extends Processo {
    ...
    processar(): void {
        if(this.cliente.Documentos.some(d => d.Tipo === TipoDocumento.Passaporte)){
            console.log('Cliente já possui Passaporte cadastrado')
            return
        }
        ...
        let cpf = new Documento(numero, TipoDocumento.Passaporte, dataExpedicao)
